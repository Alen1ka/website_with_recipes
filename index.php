        ...
        <div id="block-body">
            ...
            <div id="block-content">
                <div id="block-sorting">
                    <p id="nav-breadcrumbs"><a href="index.php">Главная страница</a> <span>Все рецепты</span></p>
                    <ul id="options-list">
                        <li>Вид: </li>
                        <li><img id="style-grid" src="images/icon-grid-active.png"/></li>
                        <li><img id="style-list" src="images/icon-list-active.png"/></li>
                        <li>Сортировать:</li>
                        <li><div class="select-sort"><?php echo $sort_name; ?>
                                <div class="select-sort-run">
                                    <ul id="sorting-list">
                                        <li><a href="index.php?sort=news">по дате создания(вначале новые)</a></li>
                                        <li><a href="index.php?sort=popular">по просмотрам</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                ...
                <?php
                    $result =  mysqli_query($link, "SELECT * FROM `table_recipe` ORDER BY $sorting");
                    if(mysqli_num_rows($result) > 0)/*если товаров больше нуля*/
                    {
                        $row = mysqli_fetch_array($result);
                        do {
                            if ($row["image"]!="" && file_exists("./images/".$row["image"]))/*есть ли в поле image название картинки и файл существует*/
                            {
